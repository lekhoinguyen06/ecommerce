...
export type CategoryTranslationWhereInput = {
  ...
  description?:
    | Prisma.StringNullableFilter<'CategoryTranslation'>
    | string
    | null;
  ...
  deletedAt?:
    | Prisma.DateTimeNullableFilter<'CategoryTranslation'>
    | Date
    | string
    | null;
...
export type CategoryTranslationWhereUniqueInput = Prisma.AtLeast<
  {
    ...
    description?:
      ...
      | null;
    createdById?:
      | Prisma.IntNullableFilter<'CategoryTranslation'>
      | number
      | null;
    updatedById?:
      | Prisma.IntNullableFilter<'CategoryTranslation'>
...
export type CategoryTranslationScalarWhereWithAggregatesInput = {
  ...
  languageId?:
    | Prisma.StringWithAggregatesFilter<'CategoryTranslation'>
    | string;
  name?: Prisma.StringWithAggregatesFilter<'CategoryTranslation'> | string;
  description?:
    | Prisma.StringNullableWithAggregatesFilter<'CategoryTranslation'>
    | string
    | null;
  createdById?:
    | Prisma.IntNullableWithAggregatesFilter<'CategoryTranslation'>
    | number
    | null;
  updatedById?:
    | Prisma.IntNullableWithAggregatesFilter<'CategoryTranslation'>
    ...
    | null;
  deletedAt?:
    | Prisma.DateTimeNullableWithAggregatesFilter<'CategoryTranslation'>
    | Date
    | string
    | null;
  createdAt?:
...
export type CategoryTranslationCreateManyLanguageInputEnvelope = {
  data:
    | Prisma.CategoryTranslationCreateManyLanguageInput
    | Prisma.CategoryTranslationCreateManyLanguageInput[];
...
export type CategoryTranslationCreateManyCreatedByInputEnvelope = {
  data:
    | Prisma.CategoryTranslationCreateManyCreatedByInput
    | Prisma.CategoryTranslationCreateManyCreatedByInput[];
  skipDuplicates?: boolean;
};
...
export type CategoryTranslationCreateManyDeletedByInputEnvelope = {
  data:
    | Prisma.CategoryTranslationCreateManyDeletedByInput
    | Prisma.CategoryTranslationCreateManyDeletedByInput[];
  skipDuplicates?: boolean;
};
...
export type CategoryTranslationCreateManyUpdatedByInputEnvelope = {
  data:
    | Prisma.CategoryTranslationCreateManyUpdatedByInput
    | Prisma.CategoryTranslationCreateManyUpdatedByInput[];
  skipDuplicates?: boolean;
};
